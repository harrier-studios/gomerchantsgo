...
Copy or symlink this folder into your Foundry user data as `Data/modules/merchants` (the directory name must match the `id` in `module.json`). Enable **Merchants** under **Manage Modules**.
